...
/**
 * Base class that represents a row from the 'rfidtap' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class RfidTap implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\RfidTapTableMap';
    ...
    /**
     * Initializes internal state of Base\RfidTap object.
     */
    ...
    /**
     * Compares this with another <code>RfidTap</code> instance.  If
     * <code>obj</code> is an instance of <code>RfidTap</code>, delegates to
     * <code>equals(RfidTap)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|RfidTap The current object, for fluid interface
     */
    ...
    public function setTime($v)
    {
        ...
        if ($this->time !== null || $dt !== null) {
            if ($this->time === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->time->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[RfidTapTableMap::COL_TIME] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : RfidTapTableMap::translateFieldName('Rfid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rfid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : RfidTapTableMap::translateFieldName('Time', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = RfidTapTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\RfidTap'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildRfidTapQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see RfidTap::setDeleted()
     * @see RfidTap::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildRfidTapQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RfidTapTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(RfidTapTableMap::COL_RFID)) {
            $modifiedColumns[':p' . $index++]  = 'rfid';
        }
        if ($this->isColumnModified(RfidTapTableMap::COL_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'time';
        }

        $sql = sprintf(
            'INSERT INTO rfidtap (%s) VALUES (%s)',
    ...
    {
        $pos = RfidTapTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['RfidTap'][$this->hashCode()] = true;
        $keys = RfidTapTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getRfid(),
            $keys[1] => $this->getTime(),
        );
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RfidTapTableMap::COL_RFID)) {
            $criteria->add(RfidTapTableMap::COL_RFID, $this->rfid);
        }
        if ($this->isColumnModified(RfidTapTableMap::COL_TIME)) {
            $criteria->add(RfidTapTableMap::COL_TIME, $this->time);
        }
    ...
    {
        $criteria = ChildRfidTapQuery::create();
        $criteria->add(RfidTapTableMap::COL_RFID, $this->rfid);
        $criteria->add(RfidTapTableMap::COL_TIME, $this->time);
    ...
    {
        return (null === $this->getRfid()) && (null === $this->getTime());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \RfidTap (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \RfidTap Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(RfidTapTableMap::DEFAULT_STRING_FORMAT);
    }
